...
console.log(exclaimThree('hi bozo'))
...
function nameCheck(name) {
  if(name.includes("Bryan")) {
    return "Hey Bryan"
  } else if(name.includes("Steven")) {
    return "Hey Steven"
  } else {
    return `Cool name, ${name}`
  }
}
nameGreeting = nameCheck("Mason Smith")
...
function faveColorFinder(color) {
  if(color.includes("red")) {
    return "red is a great color"
      ...
      return "you need to re-evaluate your favorite color choice"
  }
}
...
//CODE HERE
function theEliminator(cont, lose) {
    if(cont.includes(lose)) {
      cont.splice(cont.indexOf(lose), 1)
      return cont
    } else {
      return cont
    }
...
// console.log(emailCheck('mason@gmail.com'))
...
//CODE HERE
function buyFrogs(cash1) {
  let cash2 = cash1 / 3
  return `You can buy ${cash2} chocolate frogs`
}
// console.log(buyFrogs(22))
...
//CODE HERE
function buyFrogs2(cash1) {
  let cash2 = cash1 / 3
  cash2 = Math.floor(cash2)
  return `You can buy ${cash2} chocolate frogs`
}
// console.log(buyFrogs2(22))
...
// console.log(orderFunction(sampleArray))
